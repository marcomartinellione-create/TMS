...
const APP_VERSION='1.1.13', APP_DATE='2026-09-08';
const RELEASE_NOTE='Il grafico ⚖ Bilanciamento ora conta anche il lavoro indiretto: ogni serie vale piena sui muscoli principali dell’esercizio e mezza su quelli coinvolti di striscio, così una scheda fatta di spinte e tirate non sembra più trascurare braccia e spalle. La zona verde di riferimento è diversa per ogni gruppo — Braccia e Gambe ne chiedono di più, perché raccolgono più muscoli — e i valori vengono da 60 schede pubblicate ed equilibrate, non da una stima: non devi ottenere un poligono regolare, ma avvicinare la fascia verde. Sotto l’elenco compare Spinta · Trazione, che confronta quanto spingi e quanto tiri (contano i multiarticolari: un curl è flessione del gomito, non una trazione). Gli stessi conteggi e le stesse fasce valgono ora anche per i grafici di 📈 Progressi e del Report, e Progressi si ricorda il Training Set che avevi scelto. Esercizi e riscaldamenti si riordinano trascinando la riga dal manico a sinistra del nome, e nel riscaldamento il ▶ del video sta accanto al nome. La modalità notte è meno accesa: bordi e accenti più riposanti, senza perdere leggibilità.'; /* mini-changelog della versione; aggiornala a ogni release */
