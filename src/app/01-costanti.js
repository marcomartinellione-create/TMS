...
const RELEASE_NOTE='Nuovo nel tab Guida: «🤖 Scarica documentazione per AI» — un file di testo con tutte le funzioni, le formule e i limiti noti dell’app, pensato per essere caricato su ChatGPT, Claude o Gemini e farsi aiutare a usare il TMS con parole proprie. La stessa guida è pubblicata nel repo (docs/guida-ai.md) e si aggiorna ad ogni release'; /* mini-changelog della versione; aggiornala a ogni release */
