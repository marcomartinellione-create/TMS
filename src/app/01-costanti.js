...
const APP_VERSION='1.0.83', APP_DATE='2026-06-17';
const RELEASE_NOTE='Scheda per il cliente più comoda sul telefono. La pagina che mandi al cliente (📤 Esporta scheda) ora funziona a due schermate: prima si sceglie il giorno da un elenco, poi si compila solo quel giorno — gli esercizi uno sotto l’altro, con caselle snelle e ordinate, niente più zoom o scorrimento laterale anche con decine di esercizi. Una spunta ✔ segna i giorni già compilati. Si salva da sola, come prima.'; /* mini-changelog della versione; aggiornala a ogni release */
