...
const APP_VERSION='1.1.14', APP_DATE='2026-09-14';
const RELEASE_NOTE='Cercando un esercizio puoi scrivere anche in inglese — «bench press», «romanian deadlift», perfino «flat bench» — e trovi quello giusto scritto in italiano. L’editor degli esercizi è rifatto: i muscoli si scelgono dai chip (un clic primario, due secondario), il tipo da un elenco, il fattore ha dei limiti, e con ⧉ Duplica crei una variante partendo da una copia completa. Soprattutto: salvare un esercizio del catalogo non cancella più i campi che il modulo non mostra — prima bastava aprire e salvare per fargli perdere muscoli e istruzioni. I leg raise ora contano il peso del corpo: solo le gambe, il 40% (42% se donna) secondo le tabelle di biomeccanica, e il 25% a ginocchia piegate perché la leva è più corta; la riga ti dice quanto entra davvero, per esempio 🧍 +28 kg (40%). Nel Peso scrivi l’eventuale zavorra alle caviglie.'; /* mini-changelog della versione; aggiornala a ogni release */
