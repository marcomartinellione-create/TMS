...
const APP_VERSION='1.1.7', APP_DATE='2026-08-17';
const RELEASE_NOTE='L’app per il telefono si aggiorna su più fronti: il tasto indietro ora naviga dentro l’app invece di chiuderla; tutti i campi di un esercizio sono già visibili senza doverli aprire uno per uno; e una nuova sezione «Foto progressi» lascia scattare o scegliere tre foto (fronte, lato, retro) che arrivano automaticamente nel tuo tab Corpo insieme al resto della seduta. Se non usi il Session-RPE con un cliente, l’app gli mostra solo una casella «giornata completata» invece dei campi di fatica e durata. Corretto anche un difetto nell’ordinamento delle foto progressi salvate sul PC.'; /* mini-changelog della versione; aggiornala a ogni release */
