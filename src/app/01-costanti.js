...
const APP_VERSION='1.0.71', APP_DATE='2026-06-12';
const RELEASE_NOTE='La Guida ora spiega lo scambio scheda coach ↔ cliente: passi rapidi nella Guida rapida e sezione dedicata (§10) nella Guida completa, con i controlli di sicurezza dell’import'; /* mini-changelog della versione; aggiornala a ogni release */
