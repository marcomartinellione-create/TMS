...
const APP_VERSION='1.1.11', APP_DATE='2026-09-08';
const RELEASE_NOTE='Arriva il pulsante «🐞 Segnala» in basso a sinistra: se qualcosa non funziona o ti viene un’idea, lo scrivi da lì e l’app allega da sola versione, sistema e ultimi errori — sono quelli che permettono di capire il problema. Vedi il testo prima di mandarlo e scegli dove mandarlo: GitHub o Instagram. Nelle trazioni e nei dip la colonna 1RM ora mostra la zavorra massima (quanto potresti appenderti per una singola ripetizione) invece del carico totale: è il numero su cui si programma davvero. Corretto anche un difetto di vecchia data: i link a GitHub, Instagram e YouTube aprivano una finestra spoglia dentro l’app, ora si aprono nel browser.'; /* mini-changelog della versione; aggiornala a ogni release */
