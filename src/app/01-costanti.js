...
const APP_VERSION='1.0.75', APP_DATE='2026-06-12';
const RELEASE_NOTE='Nel tab Profilo ogni cliente ha ora i bottoni di scambio scheda direttamente nella sua riga: 📤 Esporta scheda crea la pagina compilabile da mandargli, 📥 Importa rientro registra il file che ti rimanda — lavorano sul profilo della riga (se non è quello attivo, l’app lo attiva da sola). In fondo alla pagina resta il Backup di tutti i profili insieme'; /* mini-changelog della versione; aggiornala a ogni release */
