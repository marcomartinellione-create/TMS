...
const APP_VERSION='1.1.6', APP_DATE='2026-08-15';
const RELEASE_NOTE='I «Record personali» in Progressi ora mostrano sempre il massimale vero, su tutto il tuo percorso, anche quando filtri i grafici su un solo Training Set. Il Riscaldamento si arricchisce: ora puoi scegliere anche attività cardio di base (tapis roulant, cyclette, ellittica…) misurate a minuti invece che a serie/ripetizioni, con il video di ogni esercizio a portata di tocco — tutto arriva anche sull’app del telefono. I minuti di cardio del riscaldamento entrano nel grafico radar «Volume ed equilibrio» di Progressi, senza toccare in alcun modo il calcolo del carico di allenamento (TL, ACWR, monotonia restano quelli di sempre).'; /* mini-changelog della versione; aggiornala a ogni release */
