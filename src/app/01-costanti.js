...
const APP_VERSION='1.1.5', APP_DATE='2026-08-15';
const RELEASE_NOTE='Ripulitura estetica dell’app desktop: corretti un errore che lasciava alcuni bottoni «pericolo» senza il bordo rosso, i bordi colorati sbagliati dei badge Forza/Ipertrofia/Metabolico, le date che a volte si sovrapponevano negli ultimi punti dei grafici e i tab che finivano nascosti sotto la barra in alto sugli schermi stretti. Tolto anche un doppio segno decorativo davanti ai titoli delle sezioni. Nessuna funzione è cambiata.'; /* mini-changelog della versione; aggiornala a ogni release */
