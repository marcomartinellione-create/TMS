...
const APP_VERSION='1.1.0', APP_DATE='2026-07-13';
const RELEASE_NOTE='Adesso il TMS parla anche inglese. Un interruttore IT/EN in alto (accanto alla luna) traduce tutta l’app — ogni tab, i messaggi e le due guide — tenendo l’italiano come predefinito: i clienti italiani non vedono differenze. I nomi degli esercizi in inglese arrivano dalla banca dati originale (free-exercise-db); giorni, gruppi e nomi restano invariati nei file salvati. Anche l’app del telefono «TMS Scheda» è bilingue e riconosce da sola la lingua del cellulare.'; /* mini-changelog della versione; aggiornala a ogni release */
