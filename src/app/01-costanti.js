...
const APP_VERSION='1.0.77', APP_DATE='2026-06-13';
const RELEASE_NOTE='Quattro migliorie all’uso quotidiano. 1) Allenamento: per scegliere un esercizio non c’è più il menù a tendina lunghissimo — la cella apre un selettore con barra di ricerca e lista per categoria (Invio sceglie il primo risultato). 2) La ricerca degli esercizi (sia in Allenamento sia nel tab Esercizi) ora funziona «a parole»: «panca piana bilanciere» trova «Panca piana con bilanciere». 3) Corretto il fastidio per cui, cercando nel tab Esercizi, il testo finiva scritto al contrario. 4) Report: ogni sezione si può accendere/spegnere e ora anche riordinare con le frecce ▲▼, per comporre PDF e report digitale nell’ordine che preferisci'; /* mini-changelog della versione; aggiornala a ogni release */
