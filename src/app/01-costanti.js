...
const APP_VERSION='1.0.79', APP_DATE='2026-06-16';
const RELEASE_NOTE='Migliorie al tab 🏋 Pesi e allo scambio col cliente. 1) Δ TL per SET: con le serie incrementali (＋set) ogni set mostra il proprio Δ rispetto al set di pari posizione della scorsa scheda (1° con 1°, 2° con 2°…), invece di un unico Δ di blocco — vedi la progressione set per set. 2) ＋ Esercizio ora chiede in quale giorno aggiungerlo. 3) Riordino: ogni esercizio ha le frecce ▲▼ (accanto al video) per spostarlo su/giù nel suo giorno. 4) Import del rientro dal cliente: invece di finire dritto nello Storico, l’allenamento viene caricato nella scheda Pesi per un controllo generale, e lo salvi tu a mano con «💾 Salva nello Storico» scegliendo la settimana'; /* mini-changelog della versione; aggiornala a ogni release */
