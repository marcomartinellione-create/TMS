...
const APP_VERSION='1.0.78', APP_DATE='2026-06-13';
const RELEASE_NOTE='Novità grande: il monitoraggio del CARDIO. Il tab «Allenamento» diventa «🏋 Pesi» e gli si affianca «🏃 Cardio». Registri corsa, bici, nuoto e altri sport (con la possibilità di aggiungerne) e l’app calcola il carico interno con sRPE (Foster, RPE×minuti) e TRIMP (dalla frequenza cardiaca, Banister). Ogni sport mostra i dati che contano: passo, velocità, distanza, dislivello. Puoi importare le attività direttamente da orologio o fascia con un file .TCX o .GPX (durata, FC, distanza e dislivello si compilano da soli). In Progressi ci sono grafici dedicati per ogni sport (passo/distanza/FC nel tempo), il cardio entra nell’«Equilibrio volume» (2 ore/settimana = volume equilibrato) e ha una sua sezione nel Report. Nei Pesi le attività cardio non sono più selezionabili, per non fare confusione'; /* mini-changelog della versione; aggiornala a ogni release */
