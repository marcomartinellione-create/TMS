...
const APP_VERSION='1.1.3', APP_DATE='2026-08-14';
const RELEASE_NOTE='Nel tab Pesi, accanto a Training Set, un nuovo pulsante arancione «🔥 Riscaldamento» apre — per il Training Set attivo — i riscaldamenti giorno per giorno (i giorni sono ripresi dalla scheda). Gli esercizi si scelgono dal catalogo, ma solo tra quelli di stretching: la scheda Pesi invece li esclude, così le due liste restano separate. Il riscaldamento non entra mai nel Training Load né in nessun calcolo: serve solo a prepararsi. Sistemato anche l’allineamento dei pulsanti nella barra Pesi.'; /* mini-changelog della versione; aggiornala a ogni release */
