...
const APP_VERSION='1.0.80', APP_DATE='2026-06-16';
const RELEASE_NOTE='Quattro aree migliorate. 1) 🏃 Cardio più preciso: nel Profilo puoi impostare FC a riposo e FC massima, così il carico interno TRIMP diventa più accurato (altrimenti la FC max è stimata dall’età). 2) Import attività cardio anche dai file .FIT (Garmin e orologi GPS), oltre a .TCX/.GPX: durata, distanza, FC, dislivello e sport letti in automatico. 3) Selettore esercizi: stellina ☆/★ per i preferiti e sezione «🕐 Recenti» in cima quando la ricerca è vuota, per ritrovare al volo gli esercizi che usi di più; ricerca «a parole» (più parole, anche non vicine). 4) 🍖 Alimentazione: la fase del piano (Bulk/Mantenimento/Cut) si sceglie ora coi bottoni in cima al tab (non più dal Profilo); i pasti si riordinano con le frecce ▲▼; anche gli alimenti hanno preferiti (stellina), recenti e la stessa ricerca «a parole»'; /* mini-changelog della versione; aggiornala a ogni release */
