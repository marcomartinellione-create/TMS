...
const APP_VERSION='1.0.82', APP_DATE='2026-06-17';
const RELEASE_NOTE='Nuovo: stampa della dieta in PDF. Nel tab 🍖 Alimentazione, in cima, il bottone «⬇ Stampa dieta (PDF A4)» genera un PDF A4 ORIZZONTALE del piano della fase attiva: pasti separati e, per ogni alimento, i grammi (ben in evidenza, in grassetto), le kcal e i macro, con il totale per pasto e il totale giornaliero. Pronto da dare o appendere per il cliente. Lo fa l’app da sola, offline, con un click (niente stampa del browser).'; /* mini-changelog della versione; aggiornala a ogni release */
