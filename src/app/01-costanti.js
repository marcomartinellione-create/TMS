...
const APP_VERSION='1.0.87', APP_DATE='2026-07-06';
const RELEASE_NOTE='Le due app, spiegate bene. Il TMS è l’app principale — il centro di comando dove si creano scheda e dieta e si analizzano storico e grafici — mentre «TMS Scheda» sul telefono è la sua derivata: un taccuino digitale per annotare l’allenamento in palestra, che poi riconsegna i dati al TMS. Vale per il coach coi suoi clienti (lui ha il TMS completo, loro solo il taccuino) e per chi si allena in autonomia (usa entrambi gli strumenti su di sé). Il concetto è ora spiegato nella Guida (§10), sul sito e nell’app del telefono.'; /* mini-changelog della versione; aggiornala a ogni release */
