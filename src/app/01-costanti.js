...
const APP_VERSION='1.0.85', APP_DATE='2026-07-04';
const RELEASE_NOTE='Nasce «TMS Scheda», l’app per i tuoi clienti. Il cliente la installa una volta dal sito (telefono Android o iPhone, gratis, funziona anche offline) e da lì in poi gli mandi solo il file della scheda: la apre nell’app, vede gli esercizi con i video, compila ciò che ha fatto — con bozza che si salva da sola — e ti rimanda il rientro con un tocco, anche direttamente su WhatsApp. «📤 Esporta scheda» ora crea questo file (non più la pagina HTML); l’import del rientro è invariato e i vecchi rientri restano compatibili. Privacy come sempre: i dati viaggiano solo nella vostra chat e vivono nei vostri dispositivi.'; /* mini-changelog della versione; aggiornala a ogni release */
