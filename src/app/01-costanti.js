...
const APP_VERSION='1.0.84', APP_DATE='2026-06-19';
const RELEASE_NOTE='Tre novità per chi allena i clienti. 1) Semaforo clienti: nel tab Profilo ogni cliente ha un pallino verde/giallo/rosso con ACWR, da quante settimane non aggiorna la scheda e i record recenti — a colpo d’occhio vedi chi va bene e chi è a rischio. 2) Foto progressi: nel tab Corpo carichi le foto datate (anteriore/laterale/posteriore) e le scorri come un timelapse oppure le confronti prima/dopo scegliendo le date da un calendario; puoi inserire un prima/dopo anche nel Report. Le foto restano sul tuo PC, niente cloud. 3) Co-pilota: nella scheda Pesi, accanto a ogni esercizio, un pallino dice se il peso che inserisci è una progressione sensata (verde) o un salto eccessivo o da scaricare (rosso) — è solo un suggerimento, non scrive nulla.'; /* mini-changelog della versione; aggiornala a ogni release */
