...
const APP_VERSION='1.0.86', APP_DATE='2026-07-06';
const RELEASE_NOTE='L’export della scheda porta al cliente anche l’alimentazione: nel file finisce il piano della sua fase attiva (pasti, grammi, kcal e macro già calcolati) e l’app «TMS Scheda» si apre su due sezioni — Scheda allenamento e Alimentazione. L’app del cliente si è anche rinnovata: icona nera col simbolo ✦, campo RIR da compilare dopo l’allenamento (non più precompilato), tasti di ritorno ben visibili e un pulsante in alto a destra coi QR (Instagram, YouTube, GitHub). L’import del rientro resta invariato.'; /* mini-changelog della versione; aggiornala a ogni release */
