...
const APP_VERSION='1.1.2', APP_DATE='2026-07-20';
const RELEASE_NOTE='Nel tab Pesi è arrivato il «Training Set»: un selettore accanto a Scheda per tenere pronte più versioni alternative della scheda pesi — per esempio «Palestra» e «Casa» — e passare dall’una all’altra con un clic. Cambiando set la scheda su cui stavi lavorando si salva da sola, e dal menù del selettore (voce «Azioni») puoi crearne uno nuovo — da zero o copiando un set esistente — rinominarlo o eliminarlo.'; /* mini-changelog della versione; aggiornala a ogni release */
