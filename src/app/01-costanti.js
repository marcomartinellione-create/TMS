...
const APP_VERSION='1.0.73', APP_DATE='2026-06-12';
const RELEASE_NOTE='L’annuncio dei nuovi aggiornamenti ora è una finestra in stile TMS (pergamena), con le novità in anteprima e i bottoni Scarica/Più tardi — anche la proposta di riavvio a download finito'; /* mini-changelog della versione; aggiornala a ogni release */
