...
const APP_VERSION='1.1.8', APP_DATE='2026-08-18';
const RELEASE_NOTE='Tre correzioni sull’app del telefono. La casella «Giorno completato» ora si toglie davvero se la despunti (prima restava segnata per sempre). Modificare un esercizio (es. aumentare le serie) non marca più il giorno come completato: serve un gesto esplicito di fine seduta. E il timer di recupero, che dopo un giro coach→cliente→coach poteva sparire alla riesportazione, ora conserva sempre il tempo di riposo prescritto.'; /* mini-changelog della versione; aggiornala a ogni release */
