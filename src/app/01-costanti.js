...
const APP_VERSION='1.1.4', APP_DATE='2026-08-14';
const RELEASE_NOTE='L’app per il telefono «TMS Scheda» è stata ripensata: ogni giornata è ora una seduta in tre fasi — 🔥 Riscaldamento (sola lettura, coi video), 🏋 Esercizi (si aprono a schermo pieno, con avanti/indietro) e ✅ Fine — e sotto ogni esercizio compare «l’ultima volta» per capire da dove ripartire; prima dell’invio c’è un riepilogo. Il riscaldamento del Training Set ora viaggia fino al telefono. Nel tab Progressi del PC un nuovo selettore «Dati da analizzare» ti fa guardare tutto il percorso oppure un singolo Training Set (utile quando le schede sono molto diverse tra loro).'; /* mini-changelog della versione; aggiornala a ogni release */
