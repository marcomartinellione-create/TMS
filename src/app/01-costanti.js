...
const APP_VERSION='1.0.72', APP_DATE='2026-06-12';
const RELEASE_NOTE='Backup automatici settimanali (ultime 5 copie, ripristino dal Profilo) · risolto “Caricamento parametri…” infinito sui profili non attivi · il backup ora conserva anche le sedute RPE di tutti i profili · log diagnostico interno (5 click sulla versione)'; /* mini-changelog della versione; aggiornala a ogni release */
