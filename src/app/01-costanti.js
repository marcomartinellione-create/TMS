...
const APP_VERSION='1.0.76', APP_DATE='2026-06-13';
const RELEASE_NOTE='Due novità. 1) Tab Guida: «🤖 Scarica documentazione per AI» — un file di testo con tutte le funzioni, le formule e i limiti noti dell’app, da caricare su ChatGPT, Claude o Gemini per farsi aiutare a usare il TMS con parole proprie. 2) La scheda esportata per il cliente ora salva da sola la bozza sul suo dispositivo: chiude il file, lo riapre e ritrova tutto — con istruzioni chiare in testa alla pagina (salvarla nella memoria del telefono, non compilarla dall’anteprima della chat) e un avviso esplicito dove il salvataggio automatico non è possibile'; /* mini-changelog della versione; aggiornala a ogni release */
