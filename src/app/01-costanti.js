...
const APP_VERSION='1.1.10', APP_DATE='2026-09-07';
const RELEASE_NOTE='Trazioni e dip ora contano davvero. In quegli esercizi nella colonna Peso scrivi solo la zavorra (0 se li fai a corpo libero, 15 se ti appendi 15 kg): al resto pensa l’app, che ci somma il tuo peso corporeo per calcolare 1RM, TL e record — prima una serie di trazioni pulite valeva carico zero, come se non ti fossi allenato. Sulla riga vedi quanto corpo viene sommato, e per le settimane già salvate si usa il peso che avevi a quel tempo, non quello di oggi. Vale per i 16 esercizi in cui sollevi il 100% del tuo peso (trazioni da appeso, dip alle parallele e agli anelli, salita alla corda): restano fuori le versioni al cavo, a macchina o assistite, e quelle a carico parziale come piegamenti e dip alla panca — le percentuali arriveranno più avanti.'; /* mini-changelog della versione; aggiornala a ogni release */
