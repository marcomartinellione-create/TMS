...
const APP_VERSION='1.0.81', APP_DATE='2026-06-17';
const RELEASE_NOTE='Scheda per il cliente ottimizzata per lo smartphone. La pagina che mandi al cliente (📤 Esporta scheda) ora si adatta al telefono: ogni esercizio diventa una scheda con i campi grandi e ben separati (Serie, Ripetizioni, Peso, RIR, Note), senza più scroll laterale né zoom; la tastiera numerica si apre da sola e i campi non fanno «saltare» lo schermo (font più grande). Su computer resta la tabella di prima. Sotto il cofano: pulizia del codice (rimozione di parti inutilizzate) e un controllo automatico che blocca il codice morto nelle prossime versioni — nessun cambiamento visibile per te.'; /* mini-changelog della versione; aggiornala a ogni release */
