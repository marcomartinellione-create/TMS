...
const APP_VERSION='1.1.9', APP_DATE='2026-08-19';
const RELEASE_NOTE='Rivista l’estetica del programma sul PC: angoli più morbidi, superfici con una leggera sfumatura, ombre più naturali al posto degli spigoli netti di prima — stessa app, colori invariati, solo più piacevole da guardare (anche sul PDF stampato non cambia nulla). Novità utili: nella scheda Pesi un bottone «Colonne» per nascondere quelle che non ti servono, un nuovo «Backup completo» che porta con sé anche le foto progressi (il backup normale portava solo i riferimenti), e la navigazione da tastiera ora si vede. Anche l’app del telefono segue lo stesso stile più morbido.'; /* mini-changelog della versione; aggiornala a ogni release */
