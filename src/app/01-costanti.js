...
const APP_VERSION='1.0.74', APP_DATE='2026-06-12';
const RELEASE_NOTE='Lo scambio scheda ↔ cliente ora vive dentro il riquadro di ogni profilo: apri il profilo del cliente e lì trovi Esporta/Importa, che lavorano su di lui (con più clienti niente più dubbi su chi stai esportando). In fondo alla pagina resta il Backup di tutti i profili insieme'; /* mini-changelog della versione; aggiornala a ogni release */
