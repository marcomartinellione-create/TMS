...
const APP_VERSION='1.1.1', APP_DATE='2026-07-20';
const RELEASE_NOTE='Ora dall’app del telefono «TMS Scheda» il cliente ha più strumenti in palestra: un timer di recupero che parte dal tempo di riposo scritto nella scheda (con pausa e ±15 secondi), su ogni esercizio. Quando esporti la scheda scegli tu il tipo: «fissa» (il cliente compila e basta, come prima) oppure «modificabile» (può anche aggiungere, togliere e modificare gli esercizi e segnare i test del massimale ★, che ti tornano indietro nel rientro). Guide aggiornate; l’app del telefono si aggiorna da sola.'; /* mini-changelog della versione; aggiornala a ogni release */
