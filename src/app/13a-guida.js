...
function guidaRapida(){
  return `
   ...
   <ol style="margin:0 0 6px 18px;line-height:1.9">
     <li><b>Esporta.</b> In <b>👤 Profilo</b>, nella riga del cliente, premi <b>📤 Esporta scheda</b>: crea il file della sua scheda (con i video, se vuoi). Invialo via chat o email.</li>
...
function guidaCompleta(){
  ...
  return `
   ...
   <p>Per seguire un cliente a distanza non serve che lui abbia il TMS: lui usa l'app gratuita <b>TMS Scheda</b> sul telefono (<a href="${APP_CLIENTE_URL}" target="_blank" rel="noopener">${APP_CLIENTE_URL}</a>) e la scheda <b>viaggia come file</b> — via chat o email, senza cloud.</p>
   <ol style="margin:0 0 6px 18px;line-height:1.8">
     ...
     <li><b>Esporta</b> — in <b>👤 Profilo</b>, nella riga del cliente, premi <b>📤 Esporta scheda</b> (se non è il profilo attivo, l'app lo attiva da sola). Nasce <span class="mono">Scheda_&lt;profilo&gt;_&lt;data&gt;.json</span> con la scheda giorno per giorno e il previsto in chiaro; alla domanda sui video, includili se vuoi che il cliente veda le esecuzioni offline (file più pesante). Invialo al cliente.</li>
     <li><b>Il cliente compila</b> — salva il file sul telefono e lo carica nell'app con <b>📂 Carica la scheda</b> (resta memorizzata: la ritrova a ogni apertura, con la <b>bozza salvata da sola</b> mentre compila). Sceglie il <b>giorno</b> da un elenco, compila i valori effettivi (serie, ripetizioni, peso, RIR e note per esercizio; fatica RPE 0–10 e durata in minuti per seduta — gli esercizi non sono modificabili), guarda i ▶ video, e preme <b>📩 Crea il file per il coach</b>: nasce <span class="mono">Rientro_&lt;profilo&gt;_&lt;data&gt;.json</span> da rimandarti (dove possibile con la condivisione diretta su WhatsApp).</li>
