...
function guidaRapida(){
  return `
   ...
   <div class="tbl-wrap"><table><tbody>
     <tr><td class="l"><b>👤 Profilo</b></td><td class="l">Atleta/cliente attivo e anagrafica (il tab mostra il nome del profilo attivo). In cima il <b>🚦 Cruscotto clienti</b>: tutti i profili a colpo d'occhio con un <b>semaforo</b> (🟢 ok · 🟡 attenzione · 🔴 a rischio) — ACWR, settimane dall'ultimo aggiornamento, PR recenti; «Apri» va dentro quel cliente (sola lettura, non cambia niente). Più profili = più clienti: nella riga di ognuno i bottoni dello <b>scambio scheda col cliente</b> (📤 esporta la scheda compilabile, 📥 importa il file di rientro). In fondo alla pagina il <b>Backup/Ripristino</b> di tutti i dati.</td></tr>
...
function guidaCompleta(){
  ...
  return `
   ...
   <p>In cima al tab c'è il <b>🚦 Cruscotto clienti</b>: una riga di schede, una per atleta, che ti fa vedere <b>chi sta bene e chi no senza aprirli uno per uno</b>. Ogni scheda ha un <b>semaforo</b> — 🟢 ok, 🟡 attenzione, 🔴 a rischio, ⚪ senza dati — e i numeri che contano: <b>ACWR</b> (sicurezza del carico), da <b>quante settimane non aggiorna</b> la scheda, la <b>monotonia</b> (se hai attivato il Session-RPE) e i <b>🎉 PR recenti</b>. Il semaforo è rosso se il carico è troppo alto (ACWR sopra 1.5), se la scheda è ferma da 3+ settimane o se la monotonia è alta con carico elevato; giallo per gli stessi segnali più lievi. I clienti più critici stanno in cima. Il bottone <b>«Apri»</b> attiva quel cliente e ti porta ai suoi <b>Progressi</b>: il cruscotto è solo uno specchio, <b>non modifica nulla</b>.</p>
   ...
   <ol style="margin:0 0 6px 18px;line-height:1.8">
     ...
     <li><b>Il cliente compila</b> — apre il file in qualunque browser (la pagina è <b>ottimizzata per smartphone</b>: prima sceglie il <b>giorno</b> da un elenco, poi compila solo quel giorno — un esercizio sotto l'altro, campi su una colonna e tastiera numerica, senza scroll laterale; una spunta segna i giorni già fatti), inserisce i valori effettivi (serie, ripetizioni, peso, RIR e note per esercizio; fatica RPE 0–10 e durata in minuti per seduta — gli esercizi non sono modificabili) e preme <b>📩 Crea il file per il trainer</b>: si scarica <span class="mono">Rientro_&lt;profilo&gt;_&lt;data&gt;.json</span> da rimandarti. Consiglio da girargli: <b>salvi il file nella memoria del telefono</b> e apra sempre quella copia (non l'anteprima della chat) — la <b>bozza si salva da sola</b> mentre compila, può chiudere e riprendere.</li>
