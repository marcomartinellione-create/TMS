...
function guidaCompleta(){
  ...
  return `
   ...
   <ol style="margin:0 0 6px 18px;line-height:1.8">
     ...
     <li><b>Il cliente compila</b> — apre il file in qualunque browser (la pagina è <b>ottimizzata per smartphone</b>: su telefono ogni esercizio diventa una scheda con campi grandi e tastiera numerica, senza scroll laterale), inserisce i valori effettivi (serie, ripetizioni, peso, RIR e note per esercizio; fatica RPE 0–10 e durata in minuti per seduta — gli esercizi non sono modificabili) e preme <b>📩 Crea il file per il trainer</b>: si scarica <span class="mono">Rientro_&lt;profilo&gt;_&lt;data&gt;.json</span> da rimandarti. Consiglio da girargli: <b>salvi il file nella memoria del telefono</b> e apra sempre quella copia (non l'anteprima della chat) — la <b>bozza si salva da sola</b> mentre compila, può chiudere e riprendere.</li>
