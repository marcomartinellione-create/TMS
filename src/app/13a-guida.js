...
function guidaCompleta(){
  ...
  return `
   ...
   <p><b>Trazioni e dip: quanto scrivo nel Peso?</b> Solo la <b>zavorra</b> — <b>0</b> se le fai a corpo libero, <b>15</b> se ti appendi 15 kg. Al resto pensa l'app: al peso scritto somma il tuo <b>peso corporeo</b> (preso dal tab <b>🜂 Corpo</b>) per calcolare %1RM, TL e record. La colonna <b>1RM</b> fa eccezione: lì trovi la <b>zavorra massima</b> stimata — quanto potresti appenderti per una ripetizione singola, che è il numero su cui si programma, e sulla riga te lo mostra con l'etichetta <span class="mono">🧍 +kg</span>. Per le righe già nello Storico usa il peso che avevi <b>a quel tempo</b>, non quello di oggi. Vale per gli esercizi in cui sollevi il <b>100%</b> del tuo peso: trazioni da appeso (sbarra, anelli), dip alle parallele e salita alla corda. <b>Non</b> vale per le versioni al cavo, alla macchina o assistite con elastico, né per quelle a carico parziale — dip alla panca, piegamenti, squat a corpo libero — che si compilano come prima: le percentuali di peso corporeo le affronteremo più avanti.</p>
