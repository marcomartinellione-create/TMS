...
function guidaCompleta(){
  ...
  return `
   ...
   <p><b>🔥 Riscaldamento.</b> Il pulsante arancione accanto a Training Set apre, per il set attivo, i riscaldamenti <b>giorno per giorno</b> (i giorni sono ripresi dalla scheda: aggiungine uno lì se manca). Per ogni giorno tocchi <b>＋ scegli esercizio</b> e scegli tra <b>stretching</b> oppure <b>cardio di base</b> del catalogo (corsa sul tapis roulant, cyclette, ellittica, vogatore…; il selettore della scheda Pesi mostra invece solo gli esercizi di allenamento: le liste non si mescolano); il ▶ mostra il video. Per lo stretching aggiungi serie, ripetizioni e note; il <b>cardio non ha serie/ripetizioni</b>, solo i <b>minuti</b>. Il riscaldamento <b>non conta nel TL né in ACWR/monotonia</b>: serve a prepararti — i soli minuti di cardio finiscono nel radar <b>Volume ed equilibrio</b> di 📈 Progressi (asse Cardio, come dal tab 🏃 Cardio), niente altro. Il pulsante diventa <b>◂ Scheda</b> per tornare indietro.</p>
   <p><b>2 · Leggi i calcoli dal vivo.</b> Mentre digiti, 1RM/%1RM/TL/fascia e il Δ TL di ogni set si aggiornano in tempo reale. Il pulsante <b>★</b> marca una riga come test del massimale (escluso dalla progressione del TL). Se la tabella ti sembra troppo larga, <b>▦ Colonne</b> (a destra del titolo della scheda) ti fa nascondere quelle che non guardi — Note, Rest, 1RM/%1RM, TL, Δ TL set: è solo visivo, i valori restano calcolati e salvati, e la scelta vale per il profilo attivo.</p>
   ...
   <p>Tutto in locale, <b>nessun cloud</b>. Per profilo: <span class="mono">TMS_Dati/&lt;profilo&gt;/</span> con <span class="mono">scheda.json</span>, <span class="mono">storico.json</span>, <span class="mono">corpo.json</span>, <span class="mono">alimentazione.json</span>; condivisi alla root <span class="mono">profili.json</span> ed <span class="mono">esercizi.json</span>. Copia di sicurezza anche nel browser. Migrazioni automatiche con backup <span class="mono">storico.backup.json</span>. <b>Backup/Ripristino</b> (tab Profilo): <b>⭳ Backup dati</b> esporta tutti i dati in un file JSON, <b>⭱ Ripristina</b> li reimporta. Attenzione: del <b>foto progressi</b> il backup dati porta solo i riferimenti, non le immagini — per portarti dietro anche quelle (es. su un PC nuovo) usa <b>⭳ Backup completo (con foto)</b>, che le incorpora nel file e le rimette al loro posto al ripristino. I <b>video</b> non entrano in nessuno dei due. In alternativa, backup manuale: copia la cartella <span class="mono">TMS_Dati</span>. <b>Cross-PC</b>: se la cartella è sincronizzata (es. cloud), i dati si spostano; connetti la cartella una volta per PC e non modificare in contemporanea su due dispositivi.</p>
   ...
   <ol style="margin:0 0 6px 18px;line-height:1.8">
     ...
     <li><b>Esporta</b> — in <b>👤 Profilo</b>, nella riga del cliente, premi <b>📤 Esporta scheda</b> (se non è il profilo attivo, l'app lo attiva da sola). Un popup ti chiede il <b>tipo di scheda</b>: <b>🔒 fissa</b> (il cliente compila soltanto ciò che ha fatto — come è sempre stato) oppure <b>✏️ modificabile</b> (può anche aggiungere, eliminare e modificare gli esercizi e segnare i test del massimale). Nasce <span class="mono">Scheda_&lt;profilo&gt;_&lt;data&gt;.json</span> con la scheda giorno per giorno, il previsto in chiaro e — se il piano della fase attiva non è vuoto — anche l'<b>alimentazione</b> (pasti, grammi, kcal); alla domanda sui video, includili se vuoi che il cliente veda le esecuzioni offline (file più pesante). Invialo al cliente.</li>
     <li><b>Il cliente compila</b> — salva il file sul telefono e lo carica nell'app con <b>📂 Carica la scheda</b> (resta memorizzata: la ritrova a ogni apertura, con la <b>bozza salvata da sola</b> mentre compila; il <b>tasto indietro del telefono</b> risale nell'app invece di chiuderla). L'app ha tre sezioni: <b>🏋 Scheda allenamento</b>, <b>🍖 Alimentazione</b> (il piano in sola lettura, coi grammi in evidenza) e <b>📸 Foto progressi</b> (tre riquadri fronte/lato/retro: scatta o scegli dalla galleria, le foto vengono rimpicciolite e viaggiano nel file di rientro fino al tuo tab 🜂 Corpo). Ogni giornata è una <b>seduta in tre fasi</b>: <b>🔥 Riscaldamento</b> (se lo hai messo nel Training Set: sola lettura con video, stretching o cardio a minuti, non torna indietro), <b>🏋 Esercizi</b> (tutti i campi sono <b>già visibili</b>, senza doverli aprire uno per uno — sotto ogni esercizio compare anche <b>«l'ultima volta»</b>, cosa ha fatto la volta scorsa dallo Storico) e <b>✅ Fine</b> (fatica RPE 0–10 e durata; se non usi il Session-RPE per questo profilo, qui trova solo una <b>casella «Giorno completato»</b>). Compila serie/ripetizioni/peso/RIR/note (il <b>RIR parte vuoto</b>). Se la scheda è <b>modificabile</b>, può anche <b>aggiungere, eliminare e modificare</b> gli esercizi e segnare i <b>test del massimale (★)</b>. Poi preme <b>📩 Crea il file per il coach</b> (vede un <b>riepilogo</b> di quanto ha fatto): nasce <span class="mono">Rientro_&lt;profilo&gt;_&lt;data&gt;.json</span> da rimandarti (dove possibile con la condivisione diretta su WhatsApp), con dentro anche le foto scattate. Il riscaldamento è solo informativo e <b>non entra nel rientro</b>.</li>
     <li><b>Importa</b> — nella riga del cliente, <b>📥 Importa rientro</b>: scegli il file e l'allenamento del cliente viene <b>caricato nella scheda 🏋 Pesi</b> (esercizi, valori effettivi e fatica/durata delle sedute — o i giorni segnati «completati» se non usi il Session-RPE; gli esercizi <b>aggiunti dal cliente</b> compaiono qui — se fuori catalogo, con un avviso — e i <b>test del massimale ★</b> arrivano già segnati). Le eventuali <b>foto progressi</b> vengono salvate automaticamente nel tab <b>🜂 Corpo</b> (stesso formato di quelle aggiunte a mano: fronte/lato/retro). Nella scheda Pesi fai un <b>controllo generale</b>, correggi se necessario, poi <b>💾 Salva nello Storico</b> scegliendo tu la settimana: solo allora entra nello Storico (con sedute e RPE) e alimenta TL, ACWR, grafici e Report. Niente viene scritto automaticamente.</li>
   </ol>
   ...
   <p><b>Trazioni e dip: quanto scrivo nel Peso?</b> Solo la <b>zavorra</b> — <b>0</b> se le fai a corpo libero, <b>15</b> se ti appendi 15 kg. Al resto pensa l'app: al peso scritto somma il tuo <b>peso corporeo</b> (preso dal tab <b>🜂 Corpo</b>) per calcolare %1RM, TL e record. La colonna <b>1RM</b> fa eccezione: lì trovi la <b>zavorra massima</b> stimata — quanto potresti appenderti per una ripetizione singola (segnata <span class="mono">zav</span>), che è il numero su cui si programma, e sulla riga te lo mostra con l'etichetta <span class="mono">🧍 +kg</span>. Per le righe già nello Storico usa il peso che avevi <b>a quel tempo</b>, non quello di oggi. Vale per gli esercizi in cui sollevi il <b>100%</b> del tuo peso: trazioni da appeso (sbarra, anelli), dip alle parallele e salita alla corda. <b>Non</b> vale per le versioni al cavo, alla macchina o assistite con elastico, né per quelle a carico parziale — dip alla panca, piegamenti, squat a corpo libero — che si compilano come prima: le percentuali di peso corporeo le affronteremo più avanti.</p>
...
function guidaCompletaEN(){
  ...
  return `
   ...
   <p><b>🔥 Warm-up.</b> The orange button next to Training Set opens, for the active set, the day-by-day warm-ups (the days are taken from the program: add one there if it's missing). For each day tap <b>＋ pick exercise</b> and choose <b>stretching</b> or <b>basic cardio</b> from the catalog (treadmill running, stationary bike, elliptical, rower…; the Weights program picker instead shows only training exercises: the lists don't mix); the ▶ shows the video. For stretching add sets, reps and notes; <b>cardio has no sets/reps</b>, just <b>minutes</b>. The warm-up <b>doesn't count in TL or in ACWR/monotony</b>: it's only there to help you prepare — the cardio minutes alone feed the <b>Volume & balance</b> radar in 📈 Progress (Cardio axis, same as the 🏃 Cardio tab), nothing else. The button turns into <b>◂ Program</b> to go back.</p>
   <p><b>2 · Read the live calculations.</b> As you type, 1RM/%1RM/TL/zone and each set's Δ TL update in real time. The <b>★</b> button marks a row as a 1RM test (excluded from TL progression). If the table feels too wide, <b>▦ Columns</b> (to the right of the program title) lets you hide the ones you don't look at — Notes, Rest, 1RM/%1RM, TL, Δ TL set: it's visual only, the values are still calculated and saved, and the choice applies to the active profile.</p>
   ...
   <ol style="margin:0 0 6px 18px;line-height:1.8">
     ...
     <li><b>Export</b> — in <b>👤 Profile</b>, on the client's row, press <b>📤 Export program</b> (if it's not the active profile, the app activates it by itself). A popup asks the <b>program type</b>: <b>🔒 fixed</b> (the client only fills in what they did — as it always was) or <b>✏️ editable</b> (they can also add, remove and edit exercises and mark the max tests). It creates <span class="mono">Scheda_&lt;profile&gt;_&lt;date&gt;.json</span> with the program day by day, the plan in clear text and — if the active phase plan is not empty — also the <b>nutrition</b> (meals, grams, kcal); when asked about videos, include them if you want the client to see the executions offline (heavier file). Send it to the client.</li>
     <li><b>The client fills it in</b> — they save the file on the phone and load it into the app with <b>📂 Load the program</b> (it stays stored: they find it at every opening, with the <b>draft auto-saved</b> while filling in; the <b>phone's back button</b> steps back inside the app instead of closing it). The app has three sections: <b>🏋 Training program</b>, <b>🍖 Nutrition</b> (the read-only plan, with grams highlighted) and <b>📸 Progress photos</b> (three boxes front/side/back: take a photo or pick one from the gallery, they get downscaled and travel in the log file up to your 🜂 Body tab). Each day is a <b>session in three phases</b>: <b>🔥 Warm-up</b> (if you added it to the Training Set: read-only with videos, stretching or timed cardio, doesn't come back), <b>🏋 Exercises</b> (every field is <b>already visible</b>, nothing to tap open one by one — under each exercise there's also <b>«last time»</b>, what they did last time from History) and <b>✅ Done</b> (RPE effort and duration; if this profile doesn't use Session-RPE, they just find a <b>«Day completed»</b> checkbox here). They fill in sets/reps/weight/RIR/notes (the <b>RIR starts empty</b>). If the program is <b>editable</b>, they can also <b>add, remove and edit</b> exercises and mark the <b>max tests (★)</b>. Then they press <b>📩 Create the file for the coach</b> (they see a <b>summary</b> first): it creates <span class="mono">Rientro_&lt;profile&gt;_&lt;date&gt;.json</span> to send back to you (where possible with direct WhatsApp sharing), photos included. The warm-up is informational only and <b>doesn't enter the log</b>.</li>
     <li><b>Import</b> — on the client's row, <b>📥 Import log</b>: pick the file and the client's workout is <b>loaded into the 🏋 Weights program</b> (exercises, actual values and session effort/duration — or the days marked «completed» if you don't use Session-RPE; exercises <b>added by the client</b> show up here — with a notice if off-catalog — and the <b>max tests ★</b> arrive already marked). Any <b>progress photos</b> are saved automatically into the <b>🜂 Body</b> tab (same format as the ones added by hand: front/side/back). In the Weights program do a <b>general check</b>, fix if needed, then <b>💾 Save to History</b> choosing the week yourself: only then it enters History (with sessions and RPE) and feeds TL, ACWR, charts and Report. Nothing is written automatically.</li>
   </ol>
   ...
   <p><b>Pull-ups and dips: what goes in Weight?</b> Only the <b>added weight</b> — <b>0</b> if you do them bodyweight, <b>15</b> if you hang 15 kg. The app does the rest: it adds your <b>body weight</b> (from the <b>🜂 Body</b> tab) to what you typed for %1RM, TL and records. The <b>1RM</b> column is the exception: there you get the estimated <b>maximum added weight</b> — how much you could hang for a single rep (marked <span class="mono">zav</span>), which is the number you actually program with, and shows it on the row with a <span class="mono">🧍 +kg</span> label. For rows already in History it uses the weight you had <b>back then</b>, not today's. It applies to exercises where you lift <b>100%</b> of your weight: hanging pull-ups (bar, rings), parallel-bar dips and rope climbs. It does <b>not</b> apply to cable, machine or band-assisted versions, nor to partial-load ones — bench dips, push-ups, bodyweight squats — which you fill in as before: body-weight percentages will come later.</p>
